package com.witchica.industrialization.features.storage;
...
public class EnergyStorageItem extends Item {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        ...
        pTooltipComponents.add(Component.translatable("tooltip.industrialization.fe_amount", getCurrentlyStoredEnergy(pStack), storageAmount.get()).withStyle(ChatFormatting.LIGHT_PURPLE, ChatFormatting.ITALIC));
    }
}
